...
from pydantic_ai_temporal.adapters.invoke_model_activity import OpenAIActivityInput, invoke_open_ai_model
...
def monkey_patch_open_ai_client(client: AsyncOpenAI) -> AsyncOpenAI:
...
class TemporalOpenAIProvider(Provider[AsyncOpenAI]):

    _provider : OpenAIProvider = OpenAIProvider()
    ...
    def client(self) -> AsyncOpenAI:
        return monkey_patch_open_ai_client(self._provider.client)
